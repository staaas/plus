...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('plus_event', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'plus.event': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'1t14wx'", 'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
