...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.seats_number'
        db.add_column('plus_event', 'seats_number', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.seats_number'
        db.delete_column('plus_event', 'seats_number')
    ...
    models = {
        ...
        'plus.event': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'c0sv1o'", 'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
