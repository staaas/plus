...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('plus_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=40, db_index=True)),
        ...
        db.send_create_signal('plus', ['Event'])

        # Adding model 'EventAttendance'
        db.create_table('plus_eventattendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plus.Event'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('plus', ['EventAttendance'])


    def backwards(self, orm):
        
        # Deleting model 'Event'
        db.delete_table('plus_event')

        # Deleting model 'EventAttendance'
        db.delete_table('plus_eventattendance')
